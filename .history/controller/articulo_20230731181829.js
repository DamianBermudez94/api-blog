...
const obtener = async(req, res)=>{
    ...
    // Metodo find: me devulve el listado de los elementos guardados en la db
    // MNetodo sort: sirve para poder ordenar el listado de los elementos
    const listado = await Articulos.find({}).limit(3).sort({fecha:-1}).exec();
    console.log(listado);
    if(!listado) {
